    ...
    <section id="events" className="py-24 bg-gray-900 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl px-6 md:px-12 relative">
        <div className="text-center mb-16 fade-in-section">
          ...
          <h3 className="mt-2 text-3xl md:text-4xl font-bold text-white">Upcoming Events & Workshops</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {events.map((event, index) => (
            <div 
              key={event.title}
              className="fade-in-section relative card-dark shadow-lg border-gradient group"
            ...
            >
              ...
              <div className="relative">
                <div className="mb-4 inline-block px-3 py-1 rounded-full bg-purple-900/50 text-purple-300 text-sm font-medium shimmer">
                  {event.date}
                </div>
        ...
        <div className="mt-16 text-center fade-in-section">
          <a 
            href="#join" 
            className="cyber-button rounded-full inline-flex items-center"
          >
            Stay Updated
